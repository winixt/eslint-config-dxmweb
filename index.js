 ...
 */
 ...
 module.exports = {
    ...
    rules: {
        ...
        'no-obj-calls': 'error',
        // 禁止使用 hasOwnProperty, isPrototypeOf 或 propertyIsEnumrable
        ...
        // 禁止在 setTimeout 或 setInterval 传入字符串
        ...
        //
        // Node.js 和 CommonJS
        // 这些规则与 Node.js | 浏览器 | CommonJS 中运行的代码有关
        // 
        ...
        // 禁止使用 node 中的同步方法，比如 fs.readFileSync
        // @off 使用很常见
        'no-sync': 'off',
        ...
        // @off 允许一行包含多个元素，方便数量的数组的书写
        'array-element-newline': 'off',
        // @fixable 代码块如果在一行内，那么打括号内的首尾必须有空格
        ...
        // 回调函数嵌套禁止超过 3 层，多了请用 aysnc await
        ...
        'no-lonely-if': 'off',
        // 禁止混用不同的操作符，如 let foo = a && b < 0 || c > 0
        // @off 太严格
        ...
        // @fixable 必须使用 !a 代替 a ? false : true;
        // @off 后者表达更清晰
        'no-unneeded-ternary': 'off',
        // @fixable 禁止属性前面有空格，比如 foo. bar()
        'no-whitespace-before-property': 'error',
        // @fixable 禁止 if 后面不加大括号直接写两行代码
        ...
        // @fixable 需要换行时，操作符必须放在行末
        // @off 有时放在第二行更易读
        'operator-line-break': 'off',
        // @fixable 代码块首尾必须要空行
        // @off 没必要限制
        'padded-blocks': 'off',
        // @fixable 限制语句之间的空行规则，比如变量定义后要空行
        // @off 没必要限制
        'padding-line-between-statements': 'off',
        // @fixable 对象字面量的键名禁止用引号阔起来
        // @off 没必要限制
        'quote-props': 'off',
